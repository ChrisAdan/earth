...
"""
from utils import CareerProfile, CareerLevel, CAREER_TITLES, SALARY_RANGES, INDUSTRY_MULTIPLIERS
import random
...
def determine_career_level(age: int) -> CareerLevel:
    ...
    if age < 22:
        ...
        return random.choices(
            [CareerLevel.CL_1, CareerLevel.CL_2], 
            weights=[0.8, 0.2]
        )[0]
    elif age < 30:
        # Building experience
...
def select_industry() -> str:
    ...
    Returns:
        Industry key
    """
    industries = ["tech", "business", "sales_marketing", "healthcare", "education", "general"]
...
if __name__ == "__main__":
    ...
    for age in test_ages:
        ...
        for i in range(3):
            ...
            print(f"  CL-{profile.career_level}: {profile.job_title} - ${profile.annual_income:,}")
