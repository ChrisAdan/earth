...
def test_workflow_choice_validation():
    ...
    try:
        ...
        with patch('builtins.input', return_value='1'):
            ...
            assert choice in ["people", "companies", "full_dataset"], "Should return valid workflow"
        ...
        with patch('builtins.input', side_effect=['invalid', '99', '2']):
            with patch('builtins.print'):  # Suppress error messages
                choice = cli.get_workflow_choice()
                assert choice in ["people", "companies", "full_dataset"], "Should eventually return valid workflow"
...
def test_single_workflow_parameters():
    ...
    try:
        ...
        with patch('builtins.input', side_effect=['1', '50', '1']):  # Custom count, append mode
            with patch('builtins.print'):
...
def test_full_dataset_parameters():
    ...
    try:
        ...
        with patch('builtins.input', side_effect=['1', '100', '10']):  # People, companies
            with patch('builtins.print'):
